...
class lib:
  ...
  def ggml_map_binary_f32(ctx: ffi.CData, a: ffi.CData, b: ffi.CData, fun) -> ffi.CData: ...
  ...
  def ggml_map_binary_inplace_f32(ctx: ffi.CData, a: ffi.CData, b: ffi.CData, fun) -> ffi.CData: ...

  # GGML_API struct ggml_tensor * ggml_map_custom1_f32(struct ggml_context * ctx,struct ggml_tensor * a,ggml_custom1_op_f32_t fun);
  def ggml_map_custom1_f32(ctx: ffi.CData, a: ffi.CData, fun) -> ffi.CData: ...
  ...
  def ggml_map_custom1_inplace_f32(ctx: ffi.CData, a: ffi.CData, fun) -> ffi.CData: ...
  ...
  def ggml_map_custom2_f32(ctx: ffi.CData, a: ffi.CData, b: ffi.CData, fun) -> ffi.CData: ...
  ...
  def ggml_map_custom2_inplace_f32(ctx: ffi.CData, a: ffi.CData, b: ffi.CData, fun) -> ffi.CData: ...
  ...
  def ggml_map_custom3_f32(ctx: ffi.CData, a: ffi.CData, b: ffi.CData, c: ffi.CData, fun) -> ffi.CData: ...
  ...
  def ggml_map_custom3_inplace_f32(ctx: ffi.CData, a: ffi.CData, b: ffi.CData, c: ffi.CData, fun) -> ffi.CData: ...

  # GGML_API struct ggml_tensor * ggml_map_unary_f32(struct ggml_context * ctx,struct ggml_tensor * a,ggml_unary_op_f32_t fun);
  def ggml_map_unary_f32(ctx: ffi.CData, a: ffi.CData, fun) -> ffi.CData: ...
  ...
  def ggml_map_unary_inplace_f32(ctx: ffi.CData, a: ffi.CData, fun) -> ffi.CData: ...
