...
class lib:
  ...
  def ggml_custom1_op_f32_t() -> None: ...
  #     typedef void (*ggml_custom1_op_t)(struct ggml_tensor * dst , const struct ggml_tensor * a, int ith, int nth, void * userdata);
  def ggml_custom1_op_t(dst: ffi.CData, a: ffi.CData, ith: int, nth: int, userdata: ffi.CData) -> None: ...
  #     typedef void (*ggml_custom2_op_f32_t)(struct ggml_tensor *, const struct ggml_tensor *, const struct ggml_tensor *);
  def ggml_custom2_op_f32_t() -> None: ...
  #     typedef void (*ggml_custom2_op_t)(struct ggml_tensor * dst , const struct ggml_tensor * a, const struct ggml_tensor * b, int ith, int nth, void * userdata);
  def ggml_custom2_op_t(dst: ffi.CData, a: ffi.CData, b: ffi.CData, ith: int, nth: int, userdata: ffi.CData) -> None: ...
  #     typedef void (*ggml_custom3_op_f32_t)(struct ggml_tensor *, const struct ggml_tensor *, const struct ggml_tensor *, const struct ggml_tensor *);
  def ggml_custom3_op_f32_t() -> None: ...
  #     typedef void (*ggml_custom3_op_t)(struct ggml_tensor * dst , const struct ggml_tensor * a, const struct ggml_tensor * b, const struct ggml_tensor * c, int ith, int nth, void * userdata);
  def ggml_custom3_op_t(dst: ffi.CData, a: ffi.CData, b: ffi.CData, c: ffi.CData, ith: int, nth: int, userdata: ffi.CData) -> None: ...
  ...
  def ggml_from_float_t(x: ffi.CData, y: ffi.CData, k: int) -> None: ...
  ...
  def ggml_to_float_t(x: ffi.CData, y: ffi.CData, k: int) -> None: ...
  ...
  def ggml_unary_op_f32_t() -> None: ...
  #     GGML_API size_t  ggml_used_mem(const struct ggml_context * ctx);
  def ggml_used_mem(ctx: ffi.CData) -> int: ...
  #     typedef void (*ggml_vec_dot_t)   (const int n, float * GGML_RESTRICT s, const void * GGML_RESTRICT x, const void * GGML_RESTRICT y);
  def ggml_vec_dot_t(n: int, s: ffi.CData, x: ffi.CData, y: ffi.CData) -> None: ...
  #     // offset in bytes
